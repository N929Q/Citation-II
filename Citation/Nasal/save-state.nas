...
var citation_array_radios = [
  ...
  "/controls/lighting/panel-lights-switch",
  "/controls/lighting/nav-lights-switch",
  "/controls/lighting/beacon-switch",
  "/controls/lighting/wing-lights",
  "/controls/lighting/strobe-switch",
  "/controls/lighting/recog-lights-switch",
  "/controls/lighting/strobe-switch",
  "/controls/lighting/landing-light-switch",
  "/controls/lighting/landing-light-switch[1]",
  "/controls/electric/avionics-switch",
  "/controls/gear/antiskid-sw",
